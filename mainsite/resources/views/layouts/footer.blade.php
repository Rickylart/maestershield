        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{ route('brainchild') }}">Brainchild</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="https://hotel.maestershield.com">Hotel</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Maester Mall</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Maester Auditorium</a></li>
            </ul>
          </div>
