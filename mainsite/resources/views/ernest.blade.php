   ...
   <section class="features">
    <div class="container">
      ...
      <div class="section-title">
        <h2 style="color:#D4AF37">ERNEST FRANCISCO TETTEH DOKU</h2>
      ...
      <div class="row" data-aos="fade-up">
        ...
        <div class="col-md-7 pt-4">
          <h3 style="color:#D4AF37">EXECUTIVE SECRETARY </h3>
          <p class="font-italic">
            Sir Francisco has been the General Head Counsel and the Executive Secretary of Maester Shield Ltd since its establishment in May 2018.
          </p>
          <p class="font-italic">
            He started with the company, bringing a wide and broad range of exquisite intelligence and commitment; and he is one of the top prominent principal executives. Prior to his current role, he served as a prosecutor in the Attorney Generals Department (AG’s Department) in the Prosecutions Section, Accra-Ghana, until his departure to DenHaag in the Netherlands for further studies. He later work and lived in the United Kingdom as a legal, business and entertainment consultant. After several achievements and exposures, he later returned to Ghana in 2001 and first joined LagonQuart Com.Ltd , a Legal Firm, as a Legal and Business Consultant ;and then Noah Asamany and Associates Ltd.
          </p>
